...
Uri uriProductPopular(int page) =>
    formaterApi('product-popular-view?page=$page');

Uri uriProductById(int id) => formaterApi('product-byid/$id');

Uri uriProductTypeById(int id, int page) =>
    formaterApi('product-type-byid/$id?page=$page');

Uri uriProductCategoryById(int id, int page) =>
    formaterApi('product-category-byid/$id?page=$page');

Uri uriProductSearch(String value, int page) =>
    formaterApi('product-search/$value?page=$page');
