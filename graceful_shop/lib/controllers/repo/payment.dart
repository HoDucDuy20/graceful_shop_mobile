import 'package:graceful_shop/models/create_order_response.dart';
import 'package:graceful_shop/services/url.dart';
import 'package:http/http.dart' as http;
import 'dart:async';
import 'dart:convert';
import 'package:graceful_shop/resources/utils/util.dart' as utils;
...
class ZaloPayConfig {
  ...
  static const String appUser = "Graceful Shop";
  static int transIdDefault = 1;
}

Future<CreateOrderResponse?> createOrder(int price, String code) async {
